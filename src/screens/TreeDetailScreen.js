...
const TreeDetailScreen = ({ route, navigation }) => {
  ...
  const loadTreeData = async () => {
    try {
      ...
      setTree(trees.find(tr => tr.tree_id === treeId));
    } catch {
      ...
      <View style={[styles.card, unmatchedStyle]}>
        ...
        <View style={styles.propertyRow}>
          ...
          <View style={styles.propertyContent}>
            ...
            <Text style={[styles.propertyValue, isPreFilled(tree.tree_height) && styles.prefilledText]}>
              {tree.tree_height} {t('treeDetail.meters')}
            </Text>
          </View>
        </View>
